...
class UserPhoneController extends BaseController<UserPhone, CreateUserPhoneDTO, UpdateUserPhoneDTO> {
  protected serviceName = 'Usuário App';
  protected service = userPhoneService;
  ...
  public async getUserByTelefone(req: Request, res: Response): Promise<Response> {
    try {
      ...
      const user = await userPhoneService.findByTelefone(telefone);
  ...
  public async getUserByCpf(req: Request, res: Response): Promise<Response> {
    try {
      ...
      const user = await userPhoneService.findByCpf(cpf);
  ...
  public async getUserByEmail(req: Request, res: Response): Promise<Response> {
    try {
      ...
      const user = await userPhoneService.findByEmail(email);
